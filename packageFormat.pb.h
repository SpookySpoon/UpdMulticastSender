...
class updBytes : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:udpStream.updBytes) */ {
 public:
  ...
  static const updBytes* internal_default_instance();
  ...
  void UnsafeMergeFrom(const updBytes& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_packageFormat_2eproto_impl();
  friend void  protobuf_AddDesc_packageFormat_2eproto_impl();
  friend void protobuf_AssignDesc_packageFormat_2eproto();
  friend void protobuf_ShutdownFile_packageFormat_2eproto();

  void InitAsDefaultInstance();
};
extern ::google::protobuf::internal::ExplicitlyConstructed<updBytes> updBytes_default_instance_;
